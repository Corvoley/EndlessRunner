...
public class JumpAnimationState : StateMachineBehaviour
{
    ...
    {
        //pega a duracao da animacao de pulo
        ...
        if (clips.Length > 0)
        {
            ...
            //pega a duracao do pulo do gameplay
            ...
            //setar o JumpMultiplier para que a duracao final da animacao de pulo seja = a diracao do pulo na gameplay
